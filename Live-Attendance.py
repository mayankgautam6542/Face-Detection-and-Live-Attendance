...
while True:
    ...
    encodesCurrFrame = face_recognition.face_encodings(imgS,facesInFrame)

    for encodeFace,faceLoc in zip(encodesCurrFrame, facesInFrame):
